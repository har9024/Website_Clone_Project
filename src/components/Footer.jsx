...
function Footer() {
  return (
    <div className='w-full h-screen flex gap-5 bg-zinc-900 font-["Founders_Grotesk_X"]'>
       <div className='w-1/2 h-full flex flex-col justify-between font-semibold p-20'>
       ...
       <div class Name='w-1/2 '>
        <h1 className='text-[9vw] uppercase leading-none -mb-10 font-semibold'>Presentations</h1>
        <div className='dets font-["Neue Montreal"] mt-10 flex gap-60'>
          <div className='order-last'>
                <p className='text-[2vw] mt-5 mb-2'>M:</p>
                <a className='block text-[2vw]' href="#"><u>Home</u></a>
                <a className='block text-[2vw]' href="#"><u>Services</u></a>
                <a className='block text-[2vw]' href="#"><u>Our work</u></a>
                <a className='block text-[2vw]' href="#"><u>About us</u></a>
            </div>
            <div className='md:col-span-2'>
               <h1 className='text-[2vw] mb-2'>S:</h1>
               <a className='block text-[2vw]' href="#"><u>Facebook</u></a>
               <a className='block text-[2vw]' href="#"><u>Twitter</u></a>
               <a className='block text-[2vw]' href="#"><u>Linkedin</u></a>
               <a className="block text-[2vw]" href="#"><u>Instagram</u></a>
            </div>
            <div className='loose-leading'>
              <h1 className='block text-[2vw] mt-5 mb-2 '>L:</h1>
              <a className='block text-[2vw]' href="#"><u>202-1965 W 4th Ave</u></a>
              <a className='block text-[2vw]' href="#"><u>Vancouver,Canada</u></a>
              <a className='block text-[2vw] mt-3' href="#"><u>30 Chukarina St</u></a>
            </div> 
          </div>
        </div>
    </div>    
