...
function About() {
  return (
    < div data-scroll data-scroll-speed="-.1" className='w-full p-20 bg-[#CDEA68]  rounded-tl-3xl rounded-tr-3xl text-black'>
      <h1 className=' heading text-[4vw] mt-[2vw] pt-[2vw] leading-[4.5vw] tracking-tight font-sans'>
      ...
      <div className='w-full flex gap-5 border-t-[1px] pt-10 mt-20 border-[#a1b562]'>
        ...
        <div className='w-1/2 h-[70vh]  rounded-3xl bg-[url("https://ochi.design/wp-content/uploads/2022/05/Homepage-Photo-1326x939.jpg")]'>
        </div>
      </div>
    </div>
  )
